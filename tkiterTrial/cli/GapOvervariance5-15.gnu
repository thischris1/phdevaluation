...
# set terminal postscript portrait enhanced defaultplex \
...
unset style line
set style line 1  linetype 1 linecolor rgb "#0060ad"  linewidth 2.000 pointtype 5 pointsize default pointinterval 0
set style line 2  linetype 1 linecolor rgb "#dd181f"  linewidth 2.000 pointtype 7 pointsize default pointinterval 0
unset style arrow
...
set xrange [ 0.00000 : 1.50000e-05 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "E_{gap} [enu]" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 0.00000 : 0.250000 ] noreverse nowriteback
...
EPS = "set terminal postscript color enhanced portrait font ',16'"
...
PLOT = "@EPS  set output 'bla.eps' replot"
GPFUN_out = "out(x) = sprintf(\" set output '%s.pdf'\",x)"
a = -18061.4505088157
b = 0.200551733979362
GPFUN_f = "f(x) = a*x+b"
FIT_CONVERGED = 1
FIT_NDF = 3906
FIT_STDFIT = 0.0246336908714259
FIT_WSSR = 2.37023394355668
plot  "spectrum_variance_gap_5_15.dat" u ($4):($5) ps 3 t '', f(x) lw 3t  'fit'
## fit f(x)  "spectrum_variance_gap_5_15.dat" u ($4):($5) via a,b
#    EOF
