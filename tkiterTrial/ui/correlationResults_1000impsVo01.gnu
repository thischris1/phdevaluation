...
set yrange [ 1.00000 : 7.00000 ] noreverse nowriteback
...
plot "correlationResults_1000impsVo01.dat" u ($2*9.871):($6>$5?$6/$5:$5/$6) ps 2 lw 3  t 'l_{corr} large ', "correlationResults_1000impsVo01.dat" u ($2*9.871):($8>$7?$8/$7:$7/$8) ps 2 lw 3 t 'l_{corr} small'
#    EOF
