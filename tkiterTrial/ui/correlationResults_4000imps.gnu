...
set ylabel "| {/Symbol s}_{x}/{/Symbol s}_{y} -1|" 
...
plot  "correlationResults_4000imps.dat" u ($2*9.871):(abs($8/$7 - 1)) ps 3 lw 2 t 'excentricity minimal', "correlationResults_4000imps.dat" u ($2*9.871):(abs($6/$5 -1 )) ps 3 lw 2  t 'excentric. maximal'
#    EOF
