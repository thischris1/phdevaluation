...
set ylabel "max {/Symbol s}_{x,y}/{/Symbol s}_{y,x}" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 0.500000 : 6.00000 ] noreverse nowriteback
...
plot "correlationResults_2000imps_Vo01.dat" u ($2*9.871):($6>$5?$6/$5:$5/$6) ps 2 lw 3  t 'l_{corr} large ', "correlationResults_2000imps_Vo01.dat" u ($2*9.871):($8>$7?$8/$7:$7/$8) ps 2 lw 3  t 'l_{corr} small '
#    EOF
